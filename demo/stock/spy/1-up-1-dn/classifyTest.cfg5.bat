...
classifyFiles -train=data/spy-1p0up-0p5dn-mh4-close.train.csv -test=data/spy-1p0up-0p5dn-mh4-close.test.csv  -testOut=tmpout/spy-1p0up-0p5dn-mh4-close.out.csv  -LoadSavedAnal=false -maxBuck=200 -IgnoreColumns=symbol,datetime,sam10,ram30,sam20,sl3,sbm10,sbm20,sl6,sl60,sl30,sl20,sam180,sam360,sbm90,sbm180
