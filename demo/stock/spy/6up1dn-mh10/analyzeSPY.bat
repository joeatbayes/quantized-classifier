...
classifyFiles -train=data/spy-6up-1dn-mh10-smahigh90.train.csv -test=data/spy-6up-1dn-mh10-smahigh90.test.csv -testOut=tmpout/spy-6up-1dn-mh10-smahigh90.out.csv -model=tmpout/spy-6up-1dn-mh10-smahigh90.model.csv  -minBuck=550 -maxBuck=570 -detToStdOut=false -doPreAnalyze=true -AnalSplitType=1 -AnalClassId=1  -AnalTestPort=0.2   -IgnoreColumns=symbol,datetime,rbm10,rbm20,sl3,sbm10,sam10,sbm20,ram30,rbm10,sl3,sl12,sl90,sl60,sam10,sl6,sl20,,sam180,sam360,sbm90,sbm180,sbm360
